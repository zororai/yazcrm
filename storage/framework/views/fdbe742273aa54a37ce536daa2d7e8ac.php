...
<div class="page-hdr">
  <div>
    ...
    <div class="page-sub">National Youth Helpline &middot; <?php echo e($lastUpdated ? \Carbon\Carbon::parse($lastUpdated)->format('d M Y, H:i') : 'N/A'); ?></div>
  </div>
  <div class="hdr-right">
    <div class="live-pill"><span class="live-dot"></span> Live</div>
    <div class="total-pill"><div class="tv"><?php echo e(number_format($total)); ?></div><div class="tl">All-time Interactions</div></div>
  </div>
</div>
...
<div id="sec-overview" class="section">
  ...
  <div class="bot-grid">
    ...
    <!-- Calendar -->
    <div class="glass">
      <div class="cal-nav"><span><?php echo e($calMonthName); ?></span></div>
      <div class="cal-grid">
        <?php $__currentLoopData = ['Su','Mo','Tu','We','Th','Fr','Sa']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div class="cal-dn"><?php echo e($dn); ?></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php for($e=0;$e<$calFirstDay;$e++): ?><div class="cal-d empty">0</div><?php endfor; ?>
        <?php for($d=1;$d<=$calDays;$d++): ?><div class="cal-d <?php echo e($d===$today?'today':''); ?>"><?php echo e($d); ?></div><?php endfor; ?>
      </div>
      <div style="margin-top:14px;padding-top:12px;border-top:1px solid #f1f5f9">
...
<div id="sec-calls" class="section" style="display:none">
  ...
  <div class="s-card">
    ...
    <?php if($byPurpose->isEmpty()): ?><p style="font-size:12px;color:#94a3b8;text-align:center;padding:14px 0">No purpose data yet</p><?php endif; ?>
  </div>
</div>
    ...
    <div class="tbl-wrap"><table>
      ...
      <tbody>
        <?php $__currentLoopData = $monthArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ym => $cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php $label=\Carbon\Carbon::createFromFormat('Y-m',$ym)->format('M Y');$pct=$monthSum?round($cnt/$monthSum*100,1):0;$bar=$maxMonth?round($cnt/$maxMonth*100):0; ?>
          <tr>
            <td><strong style="color:#0f172a"><?php echo e($label); ?></strong></td>
            <td><?php echo e(number_format($cnt)); ?></td><td><?php echo e($pct); ?>%</td>
...
<div class="footer">Helpline Analytics &middot; Auto-refreshes every 2 minutes &middot; <?php echo e(now()->format('d M Y')); ?></div>
</main>
</div>

<script>
// ── PHP data ──────────────────────────────────────────────────────────────────
const periodData = <?php echo json_encode($periodData, 15, 512) ?>;
const callStats  = <?php echo json_encode($callStats, 15, 512) ?>;
const months12   = <?php echo json_encode($months, 15, 512) ?>;
