...
<div class="app">
  ...
  <main class="main">
    ...
    <div id="sec-calls" class="section" style="display:none">
      <div class="kpi-row">
        <div class="kpi"><div class="kpi-icon">✅</div><div class="kpi-val"><?php echo e(number_format($byValidity->get('valid',0))); ?></div><div class="kpi-lbl">Valid Calls</div></div>
        <div class="kpi"><div class="kpi-icon">❌</div><div class="kpi-val"><?php echo e(number_format($byValidity->get('invalid',0))); ?></div><div class="kpi-lbl">Invalid Calls</div></div>
        <div class="kpi"><div class="kpi-icon">🔄</div><div class="kpi-val"><?php echo e(number_format($repeatTotal)); ?></div><div class="kpi-lbl">Repeat Callers</div><div class="kpi-sub"><?php echo e($repeatPct); ?>% repeat rate</div></div>
        <div class="kpi"><div class="kpi-icon">🚨</div><div class="kpi-val"><?php echo e(number_format($immediateAct)); ?></div><div class="kpi-lbl">Immediate Action</div></div>
      </div>
      <div class="s-card">
