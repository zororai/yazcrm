...
const CATEGORIES = [
  {
    ...
    fields: [
      ...
      { key: 'children_under_5', label: 'Children Under 5', type: 'number' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'cd4_count', label: 'CD4 Count', type: 'number' },
  ...
  },
  {
    ...
    fields: [
      { key: 'exposure_type', label: 'Exposure Type', type: 'select', options: ['Sexual', 'Needlestick', 'Blood Splash', 'Other'] },
      ...
      { key: 'pep_initiated', label: 'PEP Initiated', type: 'yesno' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'family_planning_method', label: 'Family Planning Method', type: 'text' },
      { key: 'barriers_to_fp_access', label: 'Barriers to FP Access', type: 'text' },
      { key: 'emergency_contraception_needed', label: 'Emergency Contraception Needed', type: 'yesno' },
      { key: 'srhr_topic_discussed', label: 'SRHR Topic Discussed', type: 'text' },
      { key: 'sti_symptoms', label: 'STI Symptoms', type: 'yesno' },
      { key: 'sti_type', label: 'STI Type', type: 'text' },
