...
class SearchPage extends TokenPaginationPage
    {
    /**
     ...
     * @return SearchInstance \Twilio\Rest\Knowledge\V2\SearchInstance
     */
    public function buildInstance(array $payload): SearchInstance
    {
        return new SearchInstance($this->version, $payload);
    }
    ...
    {
        return '[Twilio.Knowledge.V2.SearchPage]';
    }
}
