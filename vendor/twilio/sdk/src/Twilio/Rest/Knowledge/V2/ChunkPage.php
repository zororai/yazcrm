...
class ChunkPage extends TokenPaginationPage
    {
    /**
     ...
     * @return KnowledgeChunkInstance \Twilio\Rest\Knowledge\V2\KnowledgeChunkInstance
     */
    public function buildInstance(array $payload): KnowledgeChunkInstance
    {
        return new KnowledgeChunkInstance($this->version, $payload);
    }
