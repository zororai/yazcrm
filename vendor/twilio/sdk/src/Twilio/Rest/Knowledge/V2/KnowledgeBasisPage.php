...
class KnowledgeBasisPage extends TokenPaginationPage
    {
    /**
     ...
     * @return KnowledgeBaseInstance \Twilio\Rest\Knowledge\V2\KnowledgeBaseInstance
     */
    public function buildInstance(array $payload): KnowledgeBaseInstance
    {
        return new KnowledgeBaseInstance($this->version, $payload);
    }
