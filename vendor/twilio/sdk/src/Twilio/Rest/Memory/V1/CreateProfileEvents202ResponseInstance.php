 ...
 */
class CreateProfileEvents202ResponseInstance extends InstanceResource
{
    /**
     * Initialize the CreateProfileEvents202ResponseInstance
     *
     * @param Version $version Version that contains the resource
     * @param mixed[] $payload The response payload
     * @param string $storeId The storeId identifier
     * @param string $profileId The profileId identifier
     */
    ...
    {
        return '[Twilio.Memory.V1.CreateProfileEvents202ResponseInstance]';
    }
}
