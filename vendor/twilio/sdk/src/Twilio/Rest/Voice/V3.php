...
use Twilio\Rest\Voice\V3\TranscriptionList;
use Twilio\Version;

/**
 * @property TranscriptionList $transcriptions
 * @method \Twilio\Rest\Voice\V3\TranscriptionContext transcriptions(string $transcriptionId)
 */
class V3 extends Version
{
    ...
    /**
     * Construct the V3 version of Voice
     *
    ...
    protected function getTranscriptions(): TranscriptionList
    {
        if (!$this->_transcriptions) {
            $this->_transcriptions = new TranscriptionList($this);
        }
