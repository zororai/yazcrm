...
class OperatorPage extends TokenPaginationPage
    {
    /**
     ...
     * @return LanguageOperatorInstance \Twilio\Rest\Intelligence\V3\LanguageOperatorInstance
     */
    public function buildInstance(array $payload): LanguageOperatorInstance
    {
        return new LanguageOperatorInstance($this->version, $payload);
    }
